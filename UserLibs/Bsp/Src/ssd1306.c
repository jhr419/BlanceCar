//
//Ported from the following remote repository:
...
void ssd1306_Printf(uint8_t x, uint8_t y, SSD1306_Font_t Font, SSD1306_COLOR color, const char *format, ...) {
...
void ssd1306_clear_color(SSD1306_COLOR color){
	ssd1306_Fill(color);
	ssd1306_UpdateScreen();
}
